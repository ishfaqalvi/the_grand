...
<div class="col-md-5 align-self-center">
    <h4 class="text-themecolor">Image Slider Managment</h4>
</div>
<div class="col-md-7 align-self-center text-end">
    <div class="d-flex justify-content-end align-items-center">
        ...
        @endif
        <a href="{{ route('sliders.image.create') }}" type="button" class="btn btn-info d-none d-lg-block m-l-15 text-white">
...
@section('content')
@include('admin.slider.image.filters')
<div class="card">
    <div class="card-body">
        <h4 class="card-title">{{ __('Image Sliders') }}</h4>
            ...
            <tbody>
                @foreach ($sliders as $key => $slider)
                    <tr>
                        ...
                        <td>{{ $slider->status }}</td>
                        <td>@include('admin.slider.image.actions')</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
