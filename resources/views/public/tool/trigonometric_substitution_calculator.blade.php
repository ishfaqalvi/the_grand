<form method="POST" action="{{ route('trigonometric-substitution') }}" role="form" enctype="multipart/form-data" class="mt-5">
    @csrf
        ...
        <div class="form-group col-lg-12 mb-3">
            ...
            <div class="input-group main-input-group">
                <span class="position-relative p-0 col-12">
                    <input type="text" class="form-control" placeholder="Enter Equation here" id="MathInput" value="1/sqrt(a^2-x^2)" required="required" name="mathFunction">
