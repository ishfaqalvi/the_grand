...
@section('breadcrumb')
    ...
    <div class="col-md-7 align-self-center text-end">
        <div class="d-flex justify-content-end align-items-center">
            ...
            <a href="{{ route('pages.videogallery.create') }}" type="button" class="btn btn-info d-none d-lg-block m-l-15 text-white">
...
<div class="card">
    <div class="card-body">
        <h4 class="card-title">{{ __('Video Gallery') }}</h4>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu animated lightSpeedIn dropdown-menu-end">
                                    <a class="dropdown-item" href="{{ route('pages.videogallery.show',$page->id) }}">
                                        <i class="fa fa-fw fa-eye"></i> Show
                                    </a>
                                    <a class="dropdown-item" href="{{ route('pages.videogallery.edit',$page->id) }}">
