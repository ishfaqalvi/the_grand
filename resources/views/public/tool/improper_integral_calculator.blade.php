<form method="POST" action="{{ route('improper-integral') }}" role="form" enctype="multipart/form-data" class="mt-5">
    @csrf
    <div class="row top-input">
        ...
        <div class="form-group col-lg-4">
            ...
            <input class="form-control uinp" type="number" name="upperLimit" id="ul" value="0"/> 
        </div>                    
        <div class="form-group col-lg-4 mb-3">
            <label for="ll" class="form-label">{{ __(dynamicString('lower_limit',$language->id)) }}</label>
            <input class="form-control linp" type="number" name="lowerLimit" id="ll" value="0"/> 
        </div>
    </div>
