<div class="row">
    ...
    <div class="col-5">
        <div class="form-group col-md-12">
            {{ Form::label('image') }}
            {{ Form::file('image', ['class' => 'form-control dropify' . ($errors->has('image') ? ' is-invalid' : ''), $slider->image ? '': 'required','accept'=> 'image/png,image/jpg,image/jpeg','data-default-file' => isset($slider->image) ? asset($slider->image) : '', 'data-height' => '350']) }}
            <small class="form-control-feedback"> Image of slide size(max-width = 1440px , height = 100vh) </small>
        </div>
    </div>
