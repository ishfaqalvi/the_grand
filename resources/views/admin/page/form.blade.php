<div class="row">
    <div class="form-group col-md-6">
        ...
        <small class="form-control-feedback"> Select template ( 'Image Gallery' or 'Video Gallery' ) </small>
    </div>
    ...
    <div class="form-group col-md-6">
        ...
        <small class="form-control-feedback"> Title of page </small>
    </div>
    <div class="form-group col-md-6">
        {{ Form::label('slug') }}
    ...
    <div class="form-group col-md-6">
        ...
        <small class="form-control-feedback"> Tags of page </small>
    </div>
    <div class="form-group col-md-6">
