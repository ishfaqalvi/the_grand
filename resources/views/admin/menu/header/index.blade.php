...
<div class="col-md-5 align-self-center">
    <h4 class="text-themecolor">Header Menus</h4>
</div>
<div class="col-md-7 align-self-center text-end">
    <div class="d-flex justify-content-end align-items-center">
        ...
        @endif
        <a href="{{ route('menus.header.create') }}" type="button" class="btn btn-info d-none d-lg-block m-l-15 text-white">
...
@section('content')
@include('admin.menu.header.filters')
<div class="card">
    <div class="card-body">
        <h4 class="card-title">{{ __('Header Menus') }}</h4>
            ...
            <tbody>
                @foreach($menus as  $key => $menu)
                    <tr>
                        ...
                        <td>{{ $menu->url }}</td>
                        <td>{{ $menu->order }}</td>
                        <td>@include('admin.menu.header.actions')</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
