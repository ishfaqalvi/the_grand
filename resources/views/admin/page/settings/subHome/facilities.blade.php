<form method="POST" action="{{ route('pages.settings') }}" class="form-horizontal form-bordered facilities" role="form" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-body">
        <div class="form-group row">
            ...
            <div class="col-md-9 mt-3">
                {{ Form::text('values[home_facilities_title]', $settings['home_facilities_title'], ['class' => 'form-control','required']) }}
            </div>
            <label class="control-label text-end col-md-3 mt-3">Sub Title</label>
            <div class="col-md-9 mt-3">
                {{ Form::text('values[home_facilities_sub_title]', $settings['home_facilities_sub_title'], ['class' => 'form-control','required']) }}
            </div>
        </div>
    </div>
