<form method="POST" action="{{ route('improper-integral') }}" role="form" enctype="multipart/form-data" class="tool">
    @csrf
    <div class="row">
        <div class="form-group col-md-6">
            {{ Form::label('function') }}
            {{ Form::text('mathFunction', 'x^2/3-x', ['class' => 'form-control' . ($errors->has('mathFunction') ? ' is-invalid' : ''), 'placeholder' => 'Title','required']) }}
