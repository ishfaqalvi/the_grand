<form method="POST" action="{{ route('pages.settings') }}" class="form-horizontal form-bordered contact_us" role="form" enctype="multipart/form-data">
    ...
    <div class="form-body">
        <div class="form-group row">
            ...
            <div class="col-md-9 mt-3">
                {{ Form::textarea('values[video_contact_us_desc]', $settings['video_contact_us_desc'], ['class' => 'form-control','required','rows' => '3']) }}
            </div>
            ...
            <div class="col-md-9 mt-3">
                {{ Form::textarea('values[video_contact_us_card1_desc]', $settings['video_contact_us_card1_desc'], ['class' => 'form-control','required','rows' => '3']) }}
            </div>
            ...
            <div class="col-md-9 mt-3">
                {{ Form::textarea('values[video_contact_us_card2_desc]', $settings['video_contact_us_card2_desc'], ['class' => 'form-control','required','rows' => '3']) }}
            </div>
        </div>
    </div>
