<form method="POST" action="{{ route('pages.settings') }}" class="form-horizontal form-bordered contact_us" role="form" enctype="multipart/form-data">
    ...
    <div class="form-body">
        <div class="form-group row">
            ...
            <div class="col-md-9 mt-3">
                {{ Form::textarea('values[home_contact_us_desc]', $settings['home_contact_us_desc'], ['class' => 'form-control','required','rows' => '3','id'=>'home_contact_us_desc']) }}
            </div>
            ...
            <div class="col-md-9 mt-3">
                {{ Form::textarea('values[home_contact_us_card1_desc]', $settings['home_contact_us_card1_desc'], ['class' => 'form-control','required','rows' => '3','id'=>'home_contact_us_card1_desc']) }}
            </div>
            ...
            <div class="col-md-9 mt-3">
                {{ Form::textarea('values[home_contact_us_card2_desc]', $settings['home_contact_us_card2_desc'], ['class' => 'form-control','required','rows' => '3','id'=>'home_contact_us_card2_desc']) }}
            </div>
        </div>
    </div>
