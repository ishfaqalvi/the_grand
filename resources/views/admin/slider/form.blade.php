<div class="row">
    <div class="form-group col-md-6">
        {{ Form::label('type') }}
        {{ Form::select('type', ['Image' => 'Image', 'Video' => 'Viddeo'], $slider->type, ['class' => 'form-control' . ($errors->has('type') ? ' is-invalid' : ''), 'placeholder' => '--Select--']) }}
    ...
    <div class="form-group col-md-6">
        ...
        {{ Form::text('sub_title', $slider->sub_title, ['class' => 'form-control' . ($errors->has('sub_title') ? ' is-invalid' : ''), 'placeholder' => 'Sub Title']) }}
        {!! $errors->first('sub_title', '<div class="invalid-feedback">:message</div>') !!}
    </div>
    <div class="form-group col-md-6">
        {{ Form::label('linktype') }}
        {{ Form::select('linktype', ['Internal' => 'Internal','External' => 'External'], $slider->linktype, ['class' => 'form-control' . ($errors->has('linktype') ? ' is-invalid' : ''), 'placeholder' => '--Select--']) }}
    ...
    <div class="form-group col-md-6">
        {{ Form::label('order') }}
        {{ Form::number('order', $slider->order, ['class' => 'form-control' . ($errors->has('order') ? ' is-invalid' : ''), 'placeholder' => 'Order','min' => '0']) }}
        {!! $errors->first('order', '<div class="invalid-feedback">:message</div>') !!}
    </div>
    @if(auth()->user()->type == 'Main')
    <div class="form-group col-md-6">
        {{ Form::label('branch') }}
        {{ Form::select('branch_id', branches(), $slider->branch_id, ['class' => 'form-control' . ($errors->has('branch_id') ? ' is-invalid' : ''), 'placeholder' => '--Select--']) }}
