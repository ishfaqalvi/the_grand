...
<div class="col-md-7 align-self-center text-end">
    <div class="d-flex justify-content-end align-items-center">
        ...
        <a href="{{ route('pages.contactus.create') }}" type="button" class="btn btn-info d-none d-lg-block m-l-15 text-white">
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu animated lightSpeedIn dropdown-menu-end">
                                    <a class="dropdown-item" href="{{ route('pages.contactus.show', $page->id) }}" target="_blank">
                                        <i class="fa fa-fw fa-eye"></i> Show
                                    </a>
                                    <a class="dropdown-item" href="{{ route('pages.contactus.edit',$page->id) }}">
