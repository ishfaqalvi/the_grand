<ul class="nav nav-tabs customtab2" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link {{ $active_tab=='image' ? 'active' : ''}}" data-bs-toggle="tab" href="#image" role="tab">
...
<div class="tab-content">
    <div class="tab-pane {{ $active_tab=='navigation' ? 'active' : ''}} p-20" id="navigation" role="tabpanel">
        @include('admin.page.settings.image.detail')
    </div>
    <div class="tab-pane {{ $active_tab=='banner' ? 'active' : ''}} p-20" id="banner" role="tabpanel">
        @include('admin.page.settings.image.banner')
    </div>
    <div class="tab-pane {{ $active_tab=='image' ? 'active' : ''}} p-20" id="image" role="tabpanel">
        @include('admin.page.settings.image.image')
    </div>
    <div class="tab-pane {{ $active_tab=='testimonial' ? 'active' : ''}} p-20" id="testimonial" role="tabpanel">
        @include('admin.page.settings.image.testimonial')
    </div>
    <div class="tab-pane {{ $active_tab=='contact_us' ? 'active' : ''}} p-20" id="contact_us" role="tabpanel">
        @include('admin.page.settings.image.contact_us')
    </div>
    <div class="tab-pane {{ $active_tab=='sections' ? 'active' : ''}} p-20" id="sections" role="tabpanel">
        @include('admin.page.settings.image.sections')
    </div>
</div>