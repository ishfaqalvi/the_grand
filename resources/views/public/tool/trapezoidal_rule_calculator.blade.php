<form method="POST" action="{{ route('trapezoidal-rule') }}" role="form" enctype="multipart/form-data" class="mt-5">
    @csrf
    <div class="row top-input">
        <div class="form-group col-lg-12 mb-3">
            ...
            <div class="input-group main-input-group">
                <span class="position-relative p-0 col-12">
                    <input type="text" class="form-control" placeholder="Enter Equation here" id="MathInput" value="sin(x^2)" required="required" name="MathInput">
        ...
        <div class="form-group col-lg-4 mb-3">
            <label for="ll" class="form-label">{{ __(dynamicString('trapezoids_number',$language->id)) }}</label>
            <input class="form-control linp" type="number" name="number"/> 
        </div>
        <div class="form-group col-lg-4 mb-3">
