<form method="POST" action="{{ route('laplace-transform') }}" role="form" enctype="multipart/form-data" class="mt-5">
    @csrf
        ...
        <div class="form-group col-lg-12 mb-3">
            ...
            <div class="input-group main-input-group">
                <span class="position-relative p-0 col-12">
                    <input type="text" class="form-control" placeholder="Enter Equation here" id="MathInput" value="sin(t) t^4" required="required" name="input">
...
<script>
    function setPreview() {
        $(".equation-preview").html("$$\\mathcal{L}_t["+$("#MathInput").val()+"](s)$$");
    }
    $(function () {
        setPreview(),
